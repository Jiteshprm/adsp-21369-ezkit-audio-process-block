...
void InitSPORT()
{
    ...
    TCB_Block_A[0] = (((int) TCB_Block_C + 3)& OFFSET_MASK)| PCI ;
    TCB_Block_A[3] = (unsigned int) (Block_A)& OFFSET_MASK ;

    /*Proceed from Block B to Block A*/
    TCB_Block_B[0] = (((int) TCB_Block_A + 3)& OFFSET_MASK)|PCI ;
    TCB_Block_B[3] = ((unsigned int) Block_B)& OFFSET_MASK ;

    /*Proceed from Block C to Block B*/
    TCB_Block_C[0] = (((int) TCB_Block_B + 3)& OFFSET_MASK)|PCI ;
    TCB_Block_C[3] = ((unsigned int) Block_C)& OFFSET_MASK ;

    /*Clear the Mutli-channel control registers*/
    *pSPMCTL0 = 0;
    *pSPMCTL1 = 0;
    *pSPMCTL2 = 0;
    *pSPCTL0 = 0 ;
    ...
    *pCPSP0A = ((unsigned int) TCB_Block_A +3)& OFFSET_MASK;
    ...
    *pSPCTL1 = (SPTRAN | OPMODE | SLEN24 | SPEN_A | SCHEN_A | SDEN_A) ;
    /* write to DAC1*/
    *pCPSP1A = ((unsigned int) TCB_Block_C +3)& OFFSET_MASK;
    #endif

    #ifdef DAC2
    *pSPCTL1 |= (SPTRAN | OPMODE | SLEN24 | SPEN_B | SCHEN_B | SDEN_B) ;
    /* write to DAC2*/
    *pCPSP1B = ((unsigned int) TCB_Block_C +3)& OFFSET_MASK;
    #endif

    #ifdef DAC3
    *pSPCTL2 = (SPTRAN | OPMODE | SLEN24 | SPEN_A | SCHEN_A | SDEN_A) ;
    /* write to DAC3*/
    *pCPSP2A = ((unsigned int) TCB_Block_C +3)& OFFSET_MASK;
    #endif

    #ifdef DAC4
    *pSPCTL2 |= (SPTRAN | OPMODE | SLEN24 | SPEN_B | SCHEN_B | SDEN_B) ;
    /* write to DAC4*/
    *pCPSP2B = ((unsigned int) TCB_Block_C +3)& OFFSET_MASK;
    #endif
